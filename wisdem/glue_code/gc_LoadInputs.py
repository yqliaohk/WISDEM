...
class WindTurbineOntologyPython(object):
    ...
    def set_openmdao_vectors(self):
        ...
        if self.modeling_options["flags"]["blade"] or self.modeling_options["user_elastic"]["blade"]:
            ...
            self.modeling_options["WISDEM"]["RotorSE"]["airfoil_labels"] = self.wt_init["components"]["blade"]["outer_shape_bem"]["airfoil_position"]["labels"] # TODO YL: this was removed in nrel master, confirm if this should still be here
        ...
        if self.modeling_options["flags"]["tower"]:
            ...
            self.modeling_options["WISDEM"]["TowerSE"]["layer_name"] = [self.wt_init["components"]["tower"]["internal_structure_2d_fem"]["layers"][i]["name"] for i in range(self.modeling_options["WISDEM"]["TowerSE"]["n_layers"])] # TODO YL: this was removed in nrel master, confirm if this should still be here
    ...
    def set_opt_flags(self):
        ...
        if (self.modeling_options["flags"]["blade"] or self.modeling_options["flags"]["vawt"]) and (not self.modeling_options["user_elastic"]["blade"]):
    ...
    def write_ontology(self, wt_opt, fname_output):
        ...
        if self.modeling_options["flags"]["blade"] or self.modeling_options["user_elastic"]["blade"]:
            ...
            ].tolist() # TODO YL: it was set to rotorse. theta in nrel master
